 ...
 * @LastEditTime: 2026-07-22 11:11:08
...
export function createFormData(newTabId: number) {
    return {
        ...
        echartOptionId: "" as string, // 关联src\renderer\src\views\GisApi\body\setp3\echartGeoJson\state.ts中的optionId，对应配置文件，用来更新当前配置
        interpolation: "不插值" as "插值" | "不插值", // 是否插值
        directionArrowSize: 50, // 流场箭头大小
    }
}
