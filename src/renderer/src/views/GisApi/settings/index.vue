 ...
 * @LastEditTime: 2024-06-27 22:44:48
...
<template>
  <t-form :data="config" :colon="true">
    <t-collapse v-model="currtOpenSettingsPageNames" borderless :change="onPanelChange">
      <GeneralPanel />
    </t-collapse>
  </t-form>
</template>
...
import GeneralPanel from "./generalSetting.vue"
