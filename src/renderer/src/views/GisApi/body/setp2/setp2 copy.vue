                ...
                <t-card>
                    <div class="flex items-center justify-between mt-2">
                        <div class="flex flex-col items-start justify-between gap-1">
                            <h2 :class="['SwiperSetp__h2', 'xl:text-xl text-lg']">
                                <strong>流向单位</strong>
                            </h2>
                            <p>
                    ...
                    <div class="flex items-center justify-between mt-2">
                        <div class="flex flex-col items-start justify-between gap-1">
                            <h2 :class="['SwiperSetp__h2', 'xl:text-xl']"><strong>网格间距</strong></h2>
                    ...
                    <div class="flex items-center justify-between mt-2">
                        <div class="flex flex-col items-start justify-between gap-1">
                            <h2 :class="['SwiperSetp__h2', 'xl:text-xl']"><strong>时间序列</strong></h2>
