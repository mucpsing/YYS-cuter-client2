...
-->
<template>
    <section :class="['flex flex-col w-full gap-2', 'flex-grow-[2]', 'rounded-xl p-2 whitespace-nowrap']">
...
const echartGeoJsonRef = ref<HTMLElement & { resize: () => void; addProjectRange: (geojson: any) => void }>()
...
const geoJsonOptions = computed<{ value: string; label: string }[]>(() => {
    ...
    const fileList = [...tabStore.currtFormData.afDfsuMd5List, ...tabStore.currtFormData.beDfsuMd5List]
