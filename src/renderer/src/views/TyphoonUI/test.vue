 ...
 * @LastEditTime: 2024-12-25 23:33:25
 * @FilePath: \YYS-cuter-client2\src\renderer\src\views\TyphoonUI\test.vue
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
-->
<template>
  <div>
    <div id="echarts-amap" class="h-full w-full relative"></div>
  </div>
</template>
...
onMounted(async () => {
  const AMap = await initJSAmap(
    "ceec0c8cc35492b2a7e83f5be1043de0",
    "5a0c9bd829d2c5f203330fc94c9f0dfc",
  )
